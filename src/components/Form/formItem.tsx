...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames('wd-row', {
    'wd-row-no-label': !label
  })
  useEffect(() => {
  ...
  const labelClass = classNames({
    'wd-form-item-required': isRequired
  })
  const itemClass = classNames('wd-form-item-control', {
    'wd-form-item-has-error': hasError
  })
  ...
  return (
    <div className={rowClass}>
      { label &&
        <div className='wd-form-item-label'>
      ...
      <div className='wd-form-item'>
        ...
        { hasError && 
          <div className='wd-form-item-explain'>
